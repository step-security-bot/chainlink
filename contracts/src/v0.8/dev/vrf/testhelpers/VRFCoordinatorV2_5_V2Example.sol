...
/// @dev it is a simplified example of future version (V2) of VRFCoordinatorV2_5
contract VRFCoordinatorV2_5_V2Example is IVRFCoordinatorV2_5_Migration {
  ...
  /**
   * @inheritdoc IVRFCoordinatorV2_5_Migration
   */
  ...
  function requestRandomWords(
    VRFV2_5_Client.RandomWordsRequest calldata req
  ...
  function fulfillRandomWords(uint256 requestId) external {
    VRFConsumerBaseV2_5 consumer = VRFConsumerBaseV2_5(s_requestConsumerMapping[requestId]);
