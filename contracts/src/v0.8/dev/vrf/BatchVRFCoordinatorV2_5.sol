...
/**
 * @title BatchVRFCoordinatorV2_5
 * @notice The BatchVRFCoordinatorV2_5 contract acts as a proxy to write many random responses to the
 * @notice provided VRFCoordinatorV2_5 contract efficiently in a single transaction.
 */
contract BatchVRFCoordinatorV2_5 {
  ...
  constructor(address coordinatorAddr) {
    COORDINATOR = IVRFCoordinatorV2_5(coordinatorAddr);
  }
   ...
   */
  function fulfillRandomWords(VRFTypes.Proof[] memory proofs, VRFTypes.RequestCommitmentV2_5[] memory rcs) external {
...
interface IVRFCoordinatorV2_5 {
  function fulfillRandomWords(
    ...
    VRFTypes.RequestCommitmentV2_5 memory rc
