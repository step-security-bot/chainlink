...
func TestValidate(t *testing.T) {
	...
	v2_5Coordinator := ethkey.EIP55Address("0x92B5e28Ac583812874e4271380c7d070C5FB6E6b")
...
`,
			assertion: func(t *testing.T, os job.Job, err error) {
				...
				require.Equal(t, &v2_5Coordinator,
					os.BlockHeaderFeederSpec.CoordinatorV2_5Address)
...
`,
			assertion: func(t *testing.T, os job.Job, err error) {
				require.Equal(t, err.Error(), `at least one of "coordinatorV1Address", "coordinatorV2Address" and "coordinatorV2_5Address" must be set`)
			},
		},
		{
