...
// both the V2 and V2_5 coordinators.
...
func NewCoordinatorV2_5(c *vrf_coordinator_v2_5.VRFCoordinatorV25) CoordinatorV2_X {
...
func (c *coordinatorV2_5) RequestRandomWords(opts *bind.TransactOpts, keyHash [32]byte, subID *big.Int, requestConfirmations uint16, callbackGasLimit uint32, numWords uint32, payInEth bool) (*types.Transaction, error) {
	...
	req := vrf_coordinator_v2_5.VRFV25ClientRandomWordsRequest{
		KeyHash:              keyHash,
		SubId:                subID,
...
func (s v2Subscription) NativeBalance() *big.Int {
	panic("NativeBalance not supported on V2")
}
...
type VRFProof struct {
	...
	V2_5       vrf_coordinator_v2_5.VRFProof
}
...
func FromV2_5Proof(proof vrf_coordinator_v2_5.VRFProof) VRFProof {
	return VRFProof{
		VRFVersion: vrfcommon.V2_5,
		V2_5:       proof,
	}
...
func ToV2_5Proofs(proofs []VRFProof) []vrf_coordinator_v2_5.VRFProof {
	v2Proofs := make([]vrf_coordinator_v2_5.VRFProof, len(proofs))
	for i, proof := range proofs {
		v2Proofs[i] = proof.V2_5
	}
	return v2Proofs
}
...
type RequestCommitment struct {
	...
	V2_5       vrf_coordinator_v2_5.VRFCoordinatorV25RequestCommitment
}
...
func ToV2_5Commitments(commitments []RequestCommitment) []vrf_coordinator_v2_5.VRFCoordinatorV25RequestCommitment {
	...
	for i, commitment := range commitments {
		v2_5Commitments[i] = commitment.V2_5
	}
...
func NewRequestCommitment(val any) RequestCommitment {
	...
	case vrf_coordinator_v2_5.VRFCoordinatorV25RequestCommitment:
		return RequestCommitment{VRFVersion: vrfcommon.V2_5, V2_5: val}
	default:
...
func (r *RequestCommitment) NativePayment() bool {
	...
	nativePayment, err := extraargs.FromExtraArgsV1(r.V2_5.ExtraArgs)
	if err != nil {
		panic(err)
	}
	return nativePayment
...
func (r *RequestCommitment) CallbackGasLimit() uint32 {
	...
	return r.V2_5.CallbackGasLimit
}
