...
import (
	...
	"github.com/smartcontractkit/chainlink/v2/core/gethwrappers/generated/vrf_coordinator_v2_5_v2_example"
	"github.com/smartcontractkit/chainlink/v2/core/gethwrappers/generated/vrf_malicious_consumer_v2_5"
	"github.com/smartcontractkit/chainlink/v2/core/gethwrappers/generated/vrf_v2_5_single_consumer"
	"github.com/smartcontractkit/chainlink/v2/core/gethwrappers/generated/vrf_v2_5_sub_owner"
...
type coordinatorV2_5Universe struct {
	coordinatorV2UniverseCommon
	submanager                      *bind.TransactOpts // Subscription owner
	batchCoordinatorContract        *batch_vrf_coordinator_v2_5.BatchVRFCoordinatorV25
	batchCoordinatorContractAddress common.Address
	migrationTestCoordinator        *vrf_coordinator_v2_5_v2_example.VRFCoordinatorV25V2Example
...
func newVRFCoordinatorV2_5Universe(t *testing.T, key ethkey.KeyV2, numConsumers int, trusting bool) coordinatorV2_5Universe {
	...
	consumerABI, err := abi.JSON(strings.NewReader(
		vrfv2_5_consumer_example.VRFV25ConsumerExampleABI))
	require.NoError(t, err)
	coordinatorABI, err := abi.JSON(strings.NewReader(
		vrf_coordinator_v2_5.VRFCoordinatorV25ABI))
	require.NoError(t, err)
	...
	migrationTestCoordinatorAddress, _, migrationTestCoordinator, err := vrf_coordinator_v2_5_v2_example.DeployVRFCoordinatorV25V2Example(
	...
	batchCoordinatorAddress, _, batchCoordinatorContract, err :=
		batch_vrf_coordinator_v2_5.DeployBatchVRFCoordinatorV25(
	...
	for _, author := range vrfConsumers {
		...
		consumerContractAddress, _, consumerContract, err :=
			vrfv2_5_consumer_example.DeployVRFV25ConsumerExample(
		...
		consumerContracts = append(consumerContracts, vrftesthelpers.NewVRFV2_5Consumer(consumerContract))
	...
	maliciousConsumerContractAddress, _, maliciousConsumerContract, err :=
		vrf_malicious_consumer_v2_5.DeployVRFMaliciousConsumerV25(
	...
	upgradeableConsumerAddress, _, _, err := vrf_consumer_v2_5_upgradeable_example.DeployVRFConsumerV25UpgradeableExample(neil, backend)
	...
	proxiedConsumer, err := vrf_consumer_v2_5_upgradeable_example.NewVRFConsumerV25UpgradeableExample(
	...
	revertingConsumerContractAddress, _, revertingConsumerContract, err := vrfv2_5_reverting_example.DeployVRFV25RevertingExample(
	...
	return coordinatorV2_5Universe{
		coordinatorV2UniverseCommon: coordinatorV2UniverseCommon{
			...
			revertingConsumerContract:        vrftesthelpers.NewRevertingConsumerV2_5(revertingConsumerContract),
			revertingConsumerContractAddress: revertingConsumerContractAddress,

			consumerProxyContract:        vrftesthelpers.NewUpgradeableConsumerV2_5(proxiedConsumer),
			...
			maliciousConsumerContract:        vrftesthelpers.NewMaliciousConsumerV2_5(maliciousConsumerContract),
...
func TestVRFV2_5Integration_SingleConsumer_HappyPath_BatchFulfillment(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
...
func TestVRFV2_5Integration_SingleConsumer_HappyPath_BatchFulfillment_BigGasCallback(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
	t.Run("link payment", func(tt *testing.T) {
...
func TestVRFV2_5Integration_SingleConsumer_HappyPath(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
	t.Run("link payment", func(tt *testing.T) {
...
func TestVRFV2_5Integration_SingleConsumer_EOA_Request(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
	testEoa(
...
func TestVRFV2_5Integration_SingleConsumer_EOA_Request_Batching_Enabled(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
	testEoa(
...
func TestVRFV2_5Integration_SingleConsumer_EIP150_HappyPath(t *testing.T) {
...
func TestVRFV2_5Integration_SingleConsumer_EIP150_Revert(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
...
func TestVRFV2_5Integration_SingleConsumer_NeedsBlockhashStore(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 2, false)
	t.Run("link payment", func(tt *testing.T) {
...
func TestVRFV2_5Integration_SingleConsumer_BlockHeaderFeeder(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
	t.Run("link payment", func(tt *testing.T) {
...
func TestVRFV2_5Integration_SingleConsumer_NeedsTopUp(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
	t.Run("link payment", func(tt *testing.T) {
...
func TestVRFV2_5Integration_SingleConsumer_BigGasCallback_Sandwich(t *testing.T) {
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
...
func TestVRFV2_5Integration_SingleConsumer_MultipleGasLanes(t *testing.T) {
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
...
func TestVRFV2_5Integration_SingleConsumer_AlwaysRevertingCallback_StillFulfilled(t *testing.T) {
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 0, false)
...
func TestVRFV2_5Integration_ConsumerProxy_HappyPath(t *testing.T) {
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 0, false)
...
func TestVRFV2_5Integration_ConsumerProxy_CoordinatorZeroAddress(t *testing.T) {
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 0, false)
	testConsumerProxyCoordinatorZeroAddress(t, uni.coordinatorV2UniverseCommon)
}

func TestVRFV2_5Integration_ExternalOwnerConsumerExample(t *testing.T) {
	...
	require.NoError(t, err)
	backend.Commit()
	consumerAddress, _, consumer, err := vrf_v2_5_sub_owner.DeployVRFV25ExternalSubOwnerExample(owner, backend, coordinatorAddress, linkAddress)
	require.NoError(t, err)
	backend.Commit()
...
func TestVRFV2_5Integration_SimpleConsumerExample(t *testing.T) {
	owner := testutils.MustNewSimTransactor(t)
	random := testutils.MustNewSimTransactor(t)
	genesisData := core.GenesisAlloc{
		owner.From: {Balance: assets.Ether(10).ToInt()},
	...
	require.NoError(t, err)
	backend.Commit()
	consumerAddress, _, consumer, err := vrf_v2_5_single_consumer.DeployVRFV25SingleConsumerExample(owner, backend, coordinatorAddress, linkAddress, 1, 1, 1, [32]byte{}, false)
	require.NoError(t, err)
	backend.Commit()
	_, err = linkContract.Transfer(owner, consumerAddress, assets.Ether(2).ToInt())
	require.NoError(t, err)
...
func TestVRFV2_5Integration_TestMaliciousConsumer(t *testing.T) {
	t.Parallel()
	key := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, key, 1, false)
...
func TestVRFV2_5Integration_RequestCost(t *testing.T) {
	key := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, key, 1, false)
	...
	t.Run("proxied consumer", func(tt *testing.T) {
		...
		theAbi := evmtypes.MustGetABI(vrf_consumer_v2_5_upgradeable_example.VRFConsumerV25UpgradeableExampleMetaData.ABI)
...
func TestVRFV2_5Integration_MaxConsumersCost(t *testing.T) {
	key := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, key, 1, false)
	carol := uni.vrfConsumers[0]
	carolContract := uni.consumerContracts[0]
...
func requestAndEstimateFulfillmentCost(
	...
	require.NoError(t, err)
	proof, rc, err := proof.GenerateProofResponseV2_5(app.GetKeyStore().VRF(), vrfkey.ID(), proof.PreSeedDataV2_5{
		PreSeed:          s,
...
func TestVRFV2_5Integration_FulfillmentCost(t *testing.T) {
	key := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, key, 1, false)
...
func AssertNativeBalances(t *testing.T, backend *backends.SimulatedBackend, addresses []common.Address, balances []*big.Int) {
...
func TestVRFV2_5Integration_Migration(t *testing.T) {
	t.Parallel()
	ownerKey := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, ownerKey, 1, false)
	key1 := cltest.MustGenerateRandomKey(t)
	gasLanePriceWei := assets.GWei(10)
	config, db := heavyweight.FullTestDBV2(t, "vrfv2_5_migration", func(c *chainlink.Config, s *chainlink.Secrets) {
	...
	mine(t, requestID, subID, uni.backend, db, vrfcommon.V2_5)
...
func TestVRFV2_5Integration_CancelSubscription(t *testing.T) {
	key := cltest.MustGenerateRandomKey(t)
	uni := newVRFCoordinatorV2_5Universe(t, key, 1, false)
	consumer := uni.vrfConsumers[0]
	consumerContract := uni.consumerContracts[0]
